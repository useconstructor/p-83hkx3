...
"En app/page.tsx, agrega: (1) un texto que muestre el total de plantas disponibles junto al título del catálogo (ej: 'Catálogo de Plantas (12)'). (2) un input de búsqueda con placeholder 'Buscar plantas...' que use un estado searchQuery y filtre las plantas mostradas por nombre en tiempo real. La búsqueda filtra el array de plantas en el cliente sin peticiones adicionales."
...
- Run: npm run build
- If it passes: commit all changed files with message "change: En app/page.tsx, agrega: (1) un texto que muestre el total d" and push
